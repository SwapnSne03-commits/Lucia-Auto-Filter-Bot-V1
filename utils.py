...
class temp(object):   
    ...
    IMDB_CAP = {}
    VERIFICATIONS = {}
    SELECTED = {} # Stores selected file IDs for Multi-Select feature
    SELECT_MODE = {} # Stores select mode state for Multi-Select feature
    OFFSET = {} # Stores current offset for search results to validate pagination
